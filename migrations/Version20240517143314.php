...
final class Version20240517143314 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id UUID NOT NULL, identifier VARCHAR(100) NOT NULL, name VARCHAR(100) NOT NULL, redirect_uri VARCHAR(500) NOT NULL, is_confidential BOOLEAN NOT NULL, grant_types TEXT NOT NULL, scopes TEXT DEFAULT NULL, PRIMARY KEY(id))');
